...
const LoginDropDown = () => {
    ...
    return (
        <div className='absolute top-12 right-0 bg-background drop-shadow-2xl rounded-md w-max max-w-[340px] before:w-4 before:h-4 before:absolute before:right-4 before:-top-2 before:bg-background before:rotate-45'>
